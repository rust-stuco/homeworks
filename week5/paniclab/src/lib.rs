...
//! # Panic Lab
//!
//! The goal of this homework is to make sure that you understand how to use Rust's trait and error handling system.
//!
//! We recommend you make use of the [Rust Book](https://!doc.rust-lang.org/book/title-page.html)
//! chapters 9-10, as the "textbook" of this course. It's generally easy to follow along with,
