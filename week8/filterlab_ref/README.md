...
-   The bit vector that stores the "on" bits
-   The hashing scheme, which is a combination of:
    -   The "class" of hash functions
    -   The number of times you need to hash an element
...
This future assignment will have a leaderboard, so if you may want to start thinking about how to
optimize your implementation of a bloom filter now!
