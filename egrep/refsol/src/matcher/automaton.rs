...
pub(super) struct Automaton {
    ...
    states: Arena<State>,
    // TODO(cooper): implement cached/lazily constructed DFA
}

impl Automaton {
    /// Constructs a new Automaton to decide the pattern whose AST is given.
    pub(super) fn new_from_pattern(pat: PatternNode<u8>) -> Self {
